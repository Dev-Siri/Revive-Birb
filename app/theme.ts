...
export default function theme() {
  ...
  const xUsername = querySelectorMemoized(
  ...
  const pfp = querySelectorMemoized<HTMLImageElement>(`${pfpWrapperPath} img`);
  const pfpDiv = querySelectorMemoized(`${pfpWrapperPath} div`);
